...
<div class="row justify-content-center">
    <div class="col-lg-5">
        <main class="form-registration w-100 m-auto">
            ...
            <form action="/register/organisasi" method="post">
                @csrf
              ...
              <div class="form-floating">
                ...
                <label for="email">Email Narahubung</label>
                @error('email')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
              ...
              <button class="w-100 btn btn-lg btn-primary text-white" type="submit">Register</button>
            </form>
